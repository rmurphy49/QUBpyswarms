...
def compute_pbest(swarm):
    ...
    try:
        ...
        mask_cost = logical_or(swarm.current_cost < swarm.pbest_cost, logical_and(swarm.current_cost == swarm.pbest_cost, np.count_nonzero(swarm.position) < np.count_nonzero(swarm.pbest_pos)))
